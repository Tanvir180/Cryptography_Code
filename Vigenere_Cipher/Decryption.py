...
def decryption(plaintext, key):
    ...
    for i in range(len(plaintext)):
        ...
        # This condition is for the "Upper Case" Letter Their ascii value start from 65.
            ...
            result += chr(((((ord(char) - vkey) - 65) % 26) + 65) + 32)
        # This condition is for the "Lower case latter" their ascii value start from 97.
            ...
            result += chr((((ord(char) - vkey) - 97) % 26) + 97)    # Ekane 32 minuse kora hoice capital letter dekhate cipher text xapital letter hoy
